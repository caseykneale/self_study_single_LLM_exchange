Please write a detailed prompt that would instruct another LLM model to create this project.

Specifically this project uses the BlueR rust crate to detect whether or not a person is present or not by their bluetooth signals. 

You must be detailed and focus on the design of this software. The comments and exact variable names do not need to be replicated
but I expect the code generated from your prompt will be functionally equivalent.
